...
import com.virmersia.utkarshsharma.vr_prototype_1.Gps_Location;
 ...
 */
public class Map_Rotatae extends AppCompatActivity implements
        OnCameraMoveStartedListener,
        OnCameraMoveListener,
        OnCameraMoveCanceledListener,
        OnCameraIdleListener,
        OnMapReadyCallback {
     Gps_Location OGps_Location = new  Gps_Location();



    private static final String TAG = Map_Rotatae.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_rotatae);

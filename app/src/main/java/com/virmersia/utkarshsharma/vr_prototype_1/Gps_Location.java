 ...
 */
public class Gps_Location extends AppCompatActivity implements
        OnMapReadyCallback,
        GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener,
        LocationListener {

    private static final String TAG = Gps_Location.class.getSimpleName();
    ...
    public void onMapReady(GoogleMap map) {
        ...
        mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
            ...
            public View getInfoContents(Marker marker) {
                ...
                View infoWindow = getLayoutInflater().inflate(R.layout.activity_gps_location, null);
